...
describe('extractAllCodeBlocks (Integration with Real LLM - Returning Map)', () => {
  ...
  it('Fixture: markdown_front_matter_path.md', async () => {
    ...
    if (entry) {
      const [actualPath, fileData] = entry;
      console.log(
        `[markdown_front_matter_path] Found block containing "${expectedCodeSubstring}" -> Path: ${actualPath} (Hint was: ${expectedSubstringHint})`
      );
      expect(actualPath).not.toBe('NO_PATH');
      expect(typeof actualPath).toBe('string');
      expect(actualPath.length).toBeGreaterThan(0);
  ...
  it('Fixture: markdown_header_comment_path.md', async () => {
    ...
    if (entry) {
      const [actualPath, fileData] = entry;
      console.log(
        `[markdown_header_comment_path] Found block containing "${expectedCodeSubstring}" -> Path: ${actualPath} (Hint was: ${expectedSubstringHint})`
      );
      expect(actualPath).not.toBe('NO_PATH');
      expect(typeof actualPath).toBe('string');
      expect(actualPath.length).toBeGreaterThan(0);
  ...
  it('Fixture: markdown_heading_path.md', async () => {
    ...
    if (entry) {
      const [actualPath, fileData] = entry;
      console.log(
        `[markdown_heading_path] Found block containing "${expectedCodeSubstring}" -> Path: ${actualPath} (Hint was: ${expectedSubstringHint})`
      );
      expect(actualPath).not.toBe('NO_PATH');
      expect(typeof actualPath).toBe('string');
      expect(actualPath.length).toBeGreaterThan(0);
  ...
  it('Fixture: markdown_list_item_invalid_path.md', async () => {
    ...
    if (entry) {
      const [actualPath, fileData] = entry;
      console.log(
        `[markdown_list_item_invalid_path] Found block containing "${validSubstring}" -> Path: ${actualPath} (Hint was: src/valid-component.jsx)`
      );
      expect(actualPath).not.toBe('NO_PATH');
      expect(typeof actualPath).toBe('string');
      expect(actualPath.length).toBeGreaterThan(0);
  ...
  it('Fixture: markdown_paragraph_path.md', async () => {
    ...
    if (entry) {
      const [actualPath, fileData] = entry;
      console.log(
        `[markdown_paragraph_path] Found block containing "${expectedCodeSubstring}" -> Path: ${actualPath} (Hint was: ${expectedSubstringHint})`
      );
      expect(actualPath).not.toBe('NO_PATH');
      expect(typeof actualPath).toBe('string');
      expect(actualPath.length).toBeGreaterThan(0);
  ...
  it('Fixture: markdown_real_life_1.md', async () => {
    ...
    if (entry) {
      const [actualPath, fileData] = entry;
      console.log(
        `[markdown_real_life_1] Found block containing "${expectedCodeSubstring}" -> Path: ${actualPath} (Hint was: ${expectedSubstringHint})`
      );
      expect(actualPath).not.toBe('NO_PATH');
      expect(typeof actualPath).toBe('string');
      expect(actualPath.length).toBeGreaterThan(0);
  ...
  it('Fixture: markdown_standalone_path.md', async () => {
    ...
    if (entry) {
      const [actualPath, fileData] = entry;
      console.log(
        `[markdown_standalone_path] Found block containing "${expectedCodeSubstring}" -> Path: ${actualPath} (Hint was: ${expectedSubstringHint})`
      );
      expect(actualPath).not.toBe('NO_PATH');
      expect(typeof actualPath).toBe('string');
      expect(actualPath.length).toBeGreaterThan(0);
  ...
  it('Fixture: mixed_blocks.md', async () => {
    ...
    if (entry) {
      const [actualPath, fileData] = entry;
      console.log(
        `[mixed_blocks] Found block containing "${expectedCodeSubstring}" -> Path: ${actualPath} (Hint was: ${expectedSubstringHint})`
      );
      expect(actualPath).not.toBe('NO_PATH');
      expect(typeof actualPath).toBe('string');
      expect(actualPath.length).toBeGreaterThan(0);
  ...
  it('Fixture: path_normalization.md', async () => {
    ...
    if (entry) {
      const [actualPath, fileData] = entry;
      console.log(
        `[path_normalization] Found block containing "${expectedCodeSubstring}" -> Path: ${actualPath} (Hint was: ${expectedSubstringHint})`
      );
      expect(actualPath).not.toBe('NO_PATH');
      expect(typeof actualPath).toBe('string');
      expect(actualPath.length).toBeGreaterThan(0);
